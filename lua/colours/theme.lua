...
local utils = require("utilss")
local parse_styles = require("colours.highlight").parse_style
...
function M.compile(opts)
  ...
  local compile_nvim_api = utils.use_nvim_api
  ...
  for specname, spec in pairs(specs) do
    ...
    local output_file = utils.join_paths(output_path, specname .. file_suffix .. ".lua")
...
function M.clean()
  ...
  for _, name in ipairs(foxes) do
    local output_file = utils.join_paths(output_path, name .. file_suffix .. ".lua")
...
function M.status()
  ...
  for _, name in ipairs(foxes) do
    local file = utils.join_paths(output_path, name .. file_suffix .. ".lua")
    local status = utils.exists(file) and "✓" or "x"
